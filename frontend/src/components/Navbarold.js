  ...
  return (
    <>
      <nav className="flex justify-between px-8 items-center py-6  ">
        ...
        >
          <section className="text-black bg-red-600 flex-col absolute left-0 top-0 h-screen p-8 gap-8 z-50 w-56 flex  ">
            <IoCloseOutline
            ...
            {navlinks.map((d, i) => (
              <Link key={i} className="font-bold link" href={d.link}>
                {d.labe}
              </Link>
            ))}
          </section>
